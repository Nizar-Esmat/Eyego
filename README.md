...
- **DDD Pattern**: Domain, Infrastructure, Application, Interface layers
- **Simple Classes**: Basic constructors and methods (no complex patterns)
- **Direct Property Access**: `activity.userId` instead of getters
- **Clear Separation**: Each layer has specific responsibility
- **Junior-Friendly**: Easy to understand and modify
